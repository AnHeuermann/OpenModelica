...
#define OpenModelica__fmuLoadResource(URI) OpenModelica_fmuLoadResource(threadData, URI)
extern void OpenModelica_setFmuResourcePath(threadData_t *threadData, const char *path);
