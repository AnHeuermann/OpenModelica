...
constant DebugFlag LS_ANALYTIC_JACOBIAN = DEBUG_FLAG(85, "LSanalyticJacobian", false,
  Util.gettext("Enables analytical jacobian for linear strong components. Defaults to false"));
...
constant DebugFlag NF_API_DYNAMIC_SELECT = DEBUG_FLAG(183, "nfAPIDynamicSelect", false,
...
constant DebugFlag NF_API_NOISE = DEBUG_FLAG(184, "nfAPINoise", false,
  Util.gettext("Enables error display for the experimental new instantiation use in the OMC API."));
constant DebugFlag FMI20_DEPENDENCIES = DEBUG_FLAG(185, "disableFMIDependency", false,
...
constant ConfigFlag POST_OPT_MODULES = CONFIG_FLAG(16, "postOptModules",
  ...
  SOME(STRING_DESC_OPTION({
    ...
    ("calculateStrongComponentJacobians", Util.gettext("Generates analytical jacobian for torn linear and non-linear strong components. By default linear components and non-linear components with user-defined function calls are skipped. See also debug flags: LSanalyticJacobian, NLSanalyticJacobian and forceNLSanalyticJacobian")),
    ("collapseArrayExpressions", collapseArrayExpressionsText),
